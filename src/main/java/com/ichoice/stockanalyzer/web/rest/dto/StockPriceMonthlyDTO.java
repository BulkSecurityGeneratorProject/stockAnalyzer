...
/**
 * A DTO for the StockPriceMonthly entity.
 */
public class StockPriceMonthlyDTO implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        StockPriceMonthlyDTO stockPriceMonthlyDTO = (StockPriceMonthlyDTO) o;

        if ( ! Objects.equals(id, stockPriceMonthlyDTO.id)) return false;
